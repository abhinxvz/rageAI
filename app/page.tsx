  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="border-none shadow-none p-0 flex items-center justify-center bg-transparent rounded-2xl">
            ...
            <GlowingStarsBackgroundCard className="mx-auto rounded-2xl">
              {showThankYou ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4">
                  ...
                  />
                  <button type="submit" className="w-full bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-sm font-semibold leading-6 text-white inline-block" disabled={loading}>
                    <span className="absolute inset-0 overflow-hidden rounded-full">
                      <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                    </span>
                    <div className="relative flex items-center justify-center z-10 rounded-full bg-zinc-950 py-2 px-6 ring-1 ring-white/10">
            ...
            <div className="mx-auto max-w-xl sm:max-w-3xl space-y-6 sm:space-y-8">
              <CardSpotlight className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm h-full">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h3 className="mb-3 text-xl font-bold text-green-400">What is <span className="bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">Rage AI</span>?</h3>
                  <p className="text-gray-400">
              ...
              <CardSpotlight className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm h-full">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h3 className="mb-3 text-xl font-bold text-green-400">How does <span className="bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">Rage AI</span> work?</h3>
                  <p className="text-gray-400">
              ...
              <CardSpotlight className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm h-full">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h3 className="mb-3 text-xl font-bold text-green-400">What makes <span className="bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">Rage AI</span> different?</h3>
                  <p className="text-gray-400">
              ...
              <CardSpotlight className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm h-full">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h3 className="mb-3 text-xl font-bold text-green-400">Which apps does <span className="bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">Rage AI</span> integrate with?</h3>
                  <p className="text-gray-400">
      ...
      <footer className="border-t border-white/10 bg-black py-6 sm:py-8 px-2 sm:px-0">
        <div className="container flex flex-col items-center justify-between space-y-4 px-2 sm:px-4 md:flex-row md:space-y-0 text-center md:text-left">
          ...
          <div className="flex space-x-4 sm:space-x-6 justify-center md:justify-end w-full md:w-auto">
            ...
            >
              <img
                src="https://bhindi.io/_next/static/media/x.af2a72be.svg"
                alt="X (Twitter) logo"
                width={20}
                height={20}
